    ...
    registerProduct: function(event) {
        ...
        web3.eth.getAccounts(function(error,accounts){
            ...
            App.contracts.product.deployed().then(function(instance){
                ...
                console.log(productInstance.addProduct(web3.fromAscii(manufacturerID),web3.fromAscii(productName), web3.fromAscii(productSN), web3.fromAscii(productBrand), productPrice, {from:account}));
                return true;
